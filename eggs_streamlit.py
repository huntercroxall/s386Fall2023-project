...
with Q4:
    ...
    st.write('This boxplot shows the number of reports made by month and by classification. The lower a classification, the higher the danger of the recall. Therefore, a Class 1 recall is most dangerous to the public while a Class 3 is much less concerning to the public. As you can see Class 2 recalls tend to occur earlier in the year.')
...
with Q7:
    ...
    st.write("This donut chart depicts the number of reports based on classification. It shows that the great majority of recall events are Class 1, or of the highest risk to the public.")
